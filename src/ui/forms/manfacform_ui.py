...
################################################################################
## Form generated from reading UI file 'manfacform.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ManfacDialog = QFrame(Dialog)
        ...
        self.produces_bat_cbox = QCheckBox(self.frame)
        self.produces_bat_cbox.setObjectName(u"produces_bat_cbox")

        self.gridLayout.addWidget(self.produces_bat_cbox, 0, 0, 1, 1)
        ...
        self.produces_chg_pnt_cbox = QCheckBox(self.frame)
        self.produces_chg_pnt_cbox.setObjectName(u"produces_chg_pnt_cbox")

        self.gridLayout.addWidget(self.produces_chg_pnt_cbox, 0, 2, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.is_enabled_cbox.setText(QCoreApplication.translate("Dialog", u"aktiv", None))
        self.manufacturer_name_lbl.setText(QCoreApplication.translate("Dialog", u"Firmenname", None))
        self.address_line_1_lbl.setText(QCoreApplication.translate("Dialog", u"Adressanschrift", None))
        self.address_line_2_lbl.setText(QCoreApplication.translate("Dialog", u"Stra\u00dfe und Nr.", None))
        self.city_lbl.setText(QCoreApplication.translate("Dialog", u"Ort", None))
        self.postal_code_lbl.setText(QCoreApplication.translate("Dialog", u"Postleitzahl", None))
        self.state_lbl.setText(QCoreApplication.translate("Dialog", u"Bundesland", None))
        self.country_lbl.setText(QCoreApplication.translate("Dialog", u"Land", None))
        self.product_types_lbl.setText(QCoreApplication.translate("Dialog", u"Produkttypen", None))
        self.produces_bat_cbox.setText(QCoreApplication.translate("Dialog", u"Batterien", None))
        self.produces_modules_cbox.setText(QCoreApplication.translate("Dialog", u"Module", None))
        self.produces_chg_pnt_cbox.setText(QCoreApplication.translate("Dialog", u"Lades\u00e4ulen", None))
        self.produces_com_cbox.setText(QCoreApplication.translate("Dialog", u"Kommunikation", None))
        self.produces_misc_cbox.setText(QCoreApplication.translate("Dialog", u"Sonstige", None))
        self.produces_inverters_cbox.setText(QCoreApplication.translate("Dialog", u"Wechselrichter", None))
    # retranslateUi
