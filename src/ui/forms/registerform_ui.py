...
class Ui_RegisterForm(object):
    def setupUi(self, RegisterForm):
        ...
        self.register_name_lbl.setMinimumSize(QSize(120, 30))
        self.register_name_lbl.setMaximumSize(QSize(120, 30))

        self.horizontalLayout_4.addWidget(self.register_name_lbl, 0, Qt.AlignVCenter)

        self.register_name_txt = QLineEdit(self.frame_8)
        self.register_name_txt.setObjectName(u"register_name_txt")
        self.register_name_txt.setMinimumSize(QSize(150, 30))
        self.register_name_txt.setMaximumSize(QSize(150, 30))

        self.horizontalLayout_4.addWidget(self.register_name_txt, 0, Qt.AlignRight|Qt.AlignVCenter)
        ...
        self.register_family_name_lbl.setMinimumSize(QSize(120, 30))
        self.register_family_name_lbl.setMaximumSize(QSize(120, 30))

        self.horizontalLayout_6.addWidget(self.register_family_name_lbl, 0, Qt.AlignVCenter)
        ...
        self.register_family_name_txt.setMinimumSize(QSize(150, 30))
        self.register_family_name_txt.setMaximumSize(QSize(150, 30))

        self.horizontalLayout_6.addWidget(self.register_family_name_txt, 0, Qt.AlignRight|Qt.AlignVCenter)
        ...
        self.register_usr_lbl.setMinimumSize(QSize(120, 30))
        self.register_usr_lbl.setMaximumSize(QSize(120, 30))

        self.horizontalLayout_2.addWidget(self.register_usr_lbl, 0, Qt.AlignVCenter)

        self.register_usr_txt = QLineEdit(self.frame_3)
        self.register_usr_txt.setObjectName(u"register_usr_txt")
        self.register_usr_txt.setMinimumSize(QSize(150, 30))
        self.register_usr_txt.setMaximumSize(QSize(150, 30))

        self.horizontalLayout_2.addWidget(self.register_usr_txt, 0, Qt.AlignRight|Qt.AlignVCenter)
        ...
        self.register_pw_lbl.setMinimumSize(QSize(120, 30))
        self.register_pw_lbl.setMaximumSize(QSize(120, 30))

        self.horizontalLayout.addWidget(self.register_pw_lbl, 0, Qt.AlignVCenter)

        self.register_pw_txt = QLineEdit(self.frame)
        self.register_pw_txt.setObjectName(u"register_pw_txt")
        self.register_pw_txt.setMinimumSize(QSize(150, 30))
        self.register_pw_txt.setMaximumSize(QSize(150, 30))
        self.register_pw_txt.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout.addWidget(self.register_pw_txt, 0, Qt.AlignRight)
        ...
        self.register_rpw_lbl.setMinimumSize(QSize(120, 30))
        self.register_rpw_lbl.setMaximumSize(QSize(120, 30))
        ...
        self.register_rpw_txt.setMinimumSize(QSize(150, 30))
        self.register_rpw_txt.setMaximumSize(QSize(150, 30))
        self.register_rpw_txt.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout_3.addWidget(self.register_rpw_txt, 0, Qt.AlignRight|Qt.AlignVCenter)
        ...
        sizePolicy3.setHeightForWidth(self.assign_feedback_lbl.sizePolicy().hasHeightForWidth())
        self.assign_feedback_lbl.setSizePolicy(sizePolicy3)
