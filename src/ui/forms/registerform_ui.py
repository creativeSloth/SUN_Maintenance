...
class Ui_RegisterForm(object):
    def setupUi(self, RegisterForm):
        ...
        sizePolicy1.setHeightForWidth(self.register_name_lbl.sizePolicy().hasHeightForWidth())
        self.register_name_lbl.setSizePolicy(sizePolicy1)
        self.register_name_lbl.setMinimumSize(QSize(140, 30))
        self.register_name_lbl.setMaximumSize(QSize(140, 30))

        self.horizontalLayout_4.addWidget(self.register_name_lbl, 0, Qt.AlignLeft|Qt.AlignVCenter)

        self.register_name_txt = QLineEdit(self.frame_8)
        self.register_name_txt.setObjectName(u"register_name_txt")
        self.register_name_txt.setMinimumSize(QSize(300, 30))
        self.register_name_txt.setMaximumSize(QSize(150, 30))

        self.horizontalLayout_4.addWidget(self.register_name_txt, 0, Qt.AlignLeft|Qt.AlignVCenter)


        self.verticalLayout_3.addWidget(self.frame_8, 0, Qt.AlignLeft)
        ...
        self.register_family_name_lbl = QLabel(self.frame_10)
        self.register_family_name_lbl.setObjectName(u"register_family_name_lbl")
        self.register_family_name_lbl.setEnabled(True)
        sizePolicy1.setHeightForWidth(self.register_family_name_lbl.sizePolicy().hasHeightForWidth())
        self.register_family_name_lbl.setSizePolicy(sizePolicy1)
        self.register_family_name_lbl.setMinimumSize(QSize(140, 30))
        self.register_family_name_lbl.setMaximumSize(QSize(140, 30))

        self.horizontalLayout_7.addWidget(self.register_family_name_lbl, 0, Qt.AlignLeft)

        self.register_family_name_txt = QLineEdit(self.frame_10)
        self.register_family_name_txt.setObjectName(u"register_family_name_txt")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.register_family_name_txt.sizePolicy().hasHeightForWidth())
        self.register_family_name_txt.setSizePolicy(sizePolicy2)
        self.register_family_name_txt.setMinimumSize(QSize(300, 30))
        self.register_family_name_txt.setMaximumSize(QSize(150, 30))

        self.horizontalLayout_7.addWidget(self.register_family_name_txt, 0, Qt.AlignLeft)
        ...
        sizePolicy1.setHeightForWidth(self.register_usr_lbl.sizePolicy().hasHeightForWidth())
        self.register_usr_lbl.setSizePolicy(sizePolicy1)
        self.register_usr_lbl.setMinimumSize(QSize(140, 30))
        self.register_usr_lbl.setMaximumSize(QSize(140, 30))

        self.horizontalLayout_2.addWidget(self.register_usr_lbl, 0, Qt.AlignLeft|Qt.AlignVCenter)

        self.register_usr_txt = QLineEdit(self.frame_3)
        self.register_usr_txt.setObjectName(u"register_usr_txt")
        self.register_usr_txt.setMinimumSize(QSize(300, 30))
        self.register_usr_txt.setMaximumSize(QSize(150, 30))

        self.horizontalLayout_2.addWidget(self.register_usr_txt, 0, Qt.AlignLeft|Qt.AlignVCenter)
        ...
        sizePolicy1.setHeightForWidth(self.register_pw_lbl.sizePolicy().hasHeightForWidth())
        self.register_pw_lbl.setSizePolicy(sizePolicy1)
        self.register_pw_lbl.setMinimumSize(QSize(140, 30))
        self.register_pw_lbl.setMaximumSize(QSize(140, 30))

        self.horizontalLayout.addWidget(self.register_pw_lbl, 0, Qt.AlignLeft|Qt.AlignVCenter)

        self.register_pw_txt = QLineEdit(self.frame)
        self.register_pw_txt.setObjectName(u"register_pw_txt")
        self.register_pw_txt.setMinimumSize(QSize(300, 30))
        self.register_pw_txt.setMaximumSize(QSize(150, 30))
        self.register_pw_txt.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout.addWidget(self.register_pw_txt, 0, Qt.AlignLeft)
        ...
        sizePolicy1.setHeightForWidth(self.register_rpw_lbl.sizePolicy().hasHeightForWidth())
        self.register_rpw_lbl.setSizePolicy(sizePolicy1)
        self.register_rpw_lbl.setMinimumSize(QSize(140, 30))
        self.register_rpw_lbl.setMaximumSize(QSize(140, 30))

        self.horizontalLayout_3.addWidget(self.register_rpw_lbl, 0, Qt.AlignVCenter)

        self.register_rpw_txt = QLineEdit(self.frame_6)
        self.register_rpw_txt.setObjectName(u"register_rpw_txt")
        self.register_rpw_txt.setMinimumSize(QSize(300, 30))
        self.register_rpw_txt.setMaximumSize(QSize(150, 30))
        self.register_rpw_txt.setEchoMode(QLineEdit.Normal)

        self.horizontalLayout_3.addWidget(self.register_rpw_txt, 0, Qt.AlignLeft|Qt.AlignVCenter)


        self.verticalLayout_3.addWidget(self.frame_6, 0, Qt.AlignLeft)
        ...
        sizePolicy4.setHeightForWidth(self.assign_feedback_lbl.sizePolicy().hasHeightForWidth())
        self.assign_feedback_lbl.setSizePolicy(sizePolicy4)
        self.assign_feedback_lbl.setMinimumSize(QSize(500, 100))
        self.assign_feedback_lbl.setMaximumSize(QSize(500, 30))
        ...
        sizePolicy1.setHeightForWidth(self.assign_btn.sizePolicy().hasHeightForWidth())
        self.assign_btn.setSizePolicy(sizePolicy1)
        ...
        QWidget.setTabOrder(self.register_name_txt, self.register_family_name_txt)
        QWidget.setTabOrder(self.register_family_name_txt, self.register_usr_txt)
        QWidget.setTabOrder(self.register_usr_txt, self.register_pw_txt)
        QWidget.setTabOrder(self.register_pw_txt, self.register_rpw_txt)
        QWidget.setTabOrder(self.register_rpw_txt, self.assign_btn)
