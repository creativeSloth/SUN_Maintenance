...
class Ui_AddressAttrDialog(object):
    def setupUi(self, AddressAttrDialog):
        ...
        self.verticalLayout_3.addWidget(self.search_frame, 0, Qt.AlignTop)
        ...
        sizePolicy3.setHeightForWidth(self.postal_code_lbl.sizePolicy().hasHeightForWidth())
        self.postal_code_lbl.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.postal_code_txt.sizePolicy().hasHeightForWidth())
        self.postal_code_txt.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.state_lbl.sizePolicy().hasHeightForWidth())
        self.state_lbl.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.state_txt.sizePolicy().hasHeightForWidth())
        self.state_txt.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.country_lbl.sizePolicy().hasHeightForWidth())
        self.country_lbl.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.country_txt.sizePolicy().hasHeightForWidth())
        self.country_txt.setSizePolicy(sizePolicy3)
        ...
        self.horizontalLayout_3.addWidget(self.frame_4, 0, Qt.AlignHCenter|Qt.AlignTop)
        ...
        sizePolicy3.setHeightForWidth(self.address_line_1_lbl.sizePolicy().hasHeightForWidth())
        self.address_line_1_lbl.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.address_line_1_txt.sizePolicy().hasHeightForWidth())
        self.address_line_1_txt.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.address_line_2_lbl.sizePolicy().hasHeightForWidth())
        self.address_line_2_lbl.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.address_line_2_txt.sizePolicy().hasHeightForWidth())
        self.address_line_2_txt.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.city_lbl.sizePolicy().hasHeightForWidth())
        self.city_lbl.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.city_txt.sizePolicy().hasHeightForWidth())
        self.city_txt.setSizePolicy(sizePolicy3)
        ...
        self.verticalLayout_3.addWidget(self.AdressAttr, 0, Qt.AlignHCenter|Qt.AlignBottom)
